// app.js - Frontend Logic for Money Megaboard v3.3.3
...
function renderTable() {
    ...
    allTransactions.forEach(tx => {
        ...
        row.innerHTML = `
            <td style="text-align:center;"><input type="checkbox" class="isolate-cb" data-id="${tx.id}" ${tx.isolate ? 'checked' : ''} ${isConsolidatedTransfer && tx.transferPartnerTxId ? 'disabled' : ''}></td>
