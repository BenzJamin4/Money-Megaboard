...
async function renderUnifiedColors() {
    ...
    const renderSwatches = () => {
        ...
        if (mode === "Categories") {
            ...
            if (INCOME_CATS.includes(selectedItem) && !EXPENSE_CATS.includes(selectedItem)) itemSelect.style.color = "#27ae60";
    ...
    row2.appendChild(itemSelect);
    row2.appendChild(swatchesDiv);
    ...
    allTransactions.forEach(tx => {
        ...
        if (tx.isTransfer && tx.transferPartnerTxId) {
            ...
            if (partner) {
                ...
                displayTime = finalTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });
            }
            ...
            isConsolidatedTransfer = true;
            accountColor = "#000000";
            displayTime = tx.date.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });
