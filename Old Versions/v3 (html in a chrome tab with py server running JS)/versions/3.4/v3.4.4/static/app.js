...
function updatePieCharts() {
    ...
    const renderPie = (canvas, data) => {
        ...
        return new Chart(canvas, { type: 'pie', data: { labels, datasets: [{ data: Object.values(data), backgroundColor: labels.map(getCategoryColor), borderColor: '#000', borderWidth: 2 }] }, options: { maintainAspectRatio: false, plugins: { legend: { position: 'right' } } } });
    };
